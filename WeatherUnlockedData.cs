...
{
    //public class WeatherUnlockedData
    //{
        public class WeatherUnlockedData
        {
            ...
            public string wx_desc { get; set; } = string.Empty;
            public int wx_code { get; set; }
            public string wx_icon { get; set; } = default!;
            ...
            public string winddir_compass { get; set; } = default!;
            public float cloudtotal_pct { get; set; }
            public float vis_km { get; set; }
            public float vis_mi { get; set; }
            public object vis_desc { get; set; } = default!;
